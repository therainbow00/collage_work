...
// end of critical section
        ...
        //printf("Reader - loop #%d total seconds ran: %ld\n",reps ,v1.tv_sec);
    }
...
// end of writer's critical section
        ...
        //printf("Writer - loop #%d total seconds ran: %ld\n",reps ,v2.tv_sec);
    }
